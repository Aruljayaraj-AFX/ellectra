...
<div className="flex md:hidden lg:hidden sm:flex border rounded-3xl border-gray-300 shadow-md px-4 w-full  lg:w-2/3 justify-between  mb-10 p-3 items-center cursor-pointer hover:shadow-lg transition-shadow">
      ...
      <div className="flex flex-col lg:flex-row px-4 sm:px-6 md:px-10 gap-6 md:gap-10 mt-6 md:mt-10 justify-between">
        ...
        <div className="flex flex-col justify-between w-full gap-4 sm:gap-5">
          ...
          <div className="flex  xs:flex-row gap-3 sm:gap-5 justify-center lg:justify-end mt-4 sm:mt-6 md:mt-10">
            <div className="border rounded-3xl border-gray-300 shadow-md px-4 sm:px-5 flex gap-2 sm:gap-3 p-2 sm:p-3 items-center cursor-pointer hover:shadow-lg transition-shadow">
          ...
          <div className="hidden md:flex lg:flex justify-center lg:justify-end">
